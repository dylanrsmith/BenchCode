class rsck_plant:
    ...
    def volt_to_pot(self, volt):
        pot_value = round(((volt/1000)*230)/4.5) # voltage converted to potmeter values
        return pot_value
    ...
    def calculate(self):
        if self._rsck.rsck_enabled == 1:
            ...
            self._rsck.high_speed_current = round(self._rsck.rsck_high_spd_sol * 1829 / 765)
            ...
            if self._rsck.high_speed_current > 800:
                self._rsck.rsck_tick_rate = (10*(self._rsck.rsck_travel_limiter / 100)) #10
            elif self._rsck.high_speed_current > 350 and self._rsck.high_speed_current < 650:
                self._rsck.rsck_tick_rate = (2*(self._rsck.rsck_travel_limiter / 100)) #5
            else:
            ...
            if self._rsck.testing_active == 0:
                self._io.data_to_board(598, self.volt_to_pot(self._rsck.rsck_volt))  # chopper counter knife pos
