...
class gdhd_plant:
    ...
    def __init__(self, ob1,ob2):
        ...
        self.differential_ratio = self.main_drive_shaft_teeth / self.main_differential_gear_teeth
    ...
    def calculate(self):
        if self._gdhd.gdhd_enabled == 1:
            ...
            gdhd_pump_displacement = (self.gdhd_pump_flow_adc * self._gdhd.gdhd_max_pump_displacement) / 720
            ...
            gdhd_ground_speed_rpm = gdhd_drive_motor * self.gdhd_gear_ratio * self.differential_ratio
                                                    
            self.gdhd_ground_speed_pot = round((self.gd_rpm_scale(gdhd_ground_speed_rpm)),0)
            ...
            if self._gdhd.testing_active == 0:
                self._io.data_to_board(604, self.gdhd_gear_speed_pot) #SENSOR,RPM 1ST GEAR
                self._io.data_to_board(603, self.gdhd_ground_speed_pot) #SENSOR,RPM GROUND SPEED
