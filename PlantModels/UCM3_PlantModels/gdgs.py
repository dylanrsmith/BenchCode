    ...
    def calculate(self):
        if self._gdgs.gdgs_enabled == 1:
            if self._gdgs.testing_active == 0:
                self._gdgs.gdgs_gear_shift_inc = self._io.data_read(714)#714 ##Shift gear increasing
                self._gdgs.gdgs_gear_shift_dec = self._io.data_read(970)#970  ##Shift gear decreasing
