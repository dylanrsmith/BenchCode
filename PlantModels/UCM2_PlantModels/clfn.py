...
class clfn_plant:
    ...
    clfn_list_current = [0, 600, 700, 800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 2500]
    clfn_list_rpm = [0, 316.026988, 428.4011822, 553.1259639, 688.1017395,
                     831.2289157, 980.4078991, 1133.539096,
                     1288.522914, 1443.259759, 1595.650038, 1595.650038]
    ...
    def calculate_RPM(self):
        if self._clfn.clfn_enable == 1:
            ...
            hydro_RPM = self._lut.get_val(self.clfn_list_current, self.clfn_list_rpm, self._clfn.clfn_curr)
            if engine_spd > 0:
