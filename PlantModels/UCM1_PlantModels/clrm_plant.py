...
class clrm_plant:
    ...
    def calculate_speed(self):
        ...
        if self.Engine_RPM >= 1000 and self.Engine_RPM < 1450 and self._cl.Aux_PTO_enabled == 1:
            self._io.data_to_board(91, self.Low_Idle_Value)
            
        elif self.Engine_RPM > 1450 and self._cl.Aux_PTO_enabled == 1: # and self.Engine_RPM = 1900:
