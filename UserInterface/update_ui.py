...
class update_ui:
    ...
    def update_ui_ghcv(self):
        ...
        self._ui.open_label.insert(
            0, "{:.2f}".format(float(self._ui.cover_open_sensor))
        )
        self._ui.close_label.delete(0, 100)
        self._ui.close_label.insert(
            0, "{:.2f}".format(float(self._ui.cover_close_sensor))
        )
    ...
    def update_ui_thcc(self):
        ...
        self._ui.thcc_time_taken_label.insert(
            0, "{:.2f}".format(float(self._ui.thcc_time_taken))
        )

        self._ui.thcc_pot_volt_label.delete(0, 100)
        self._ui.thcc_pot_volt_label.insert(
            0, "{:.2f}".format(float(self._ui.thcc_pot_volt))
        )
    ...
    def update_ui_gdpb(self):
        ...
        self._ui.gdpb_park_brake_sensor_label.insert(
            0, "{:.2f}".format(float(self._ui.gdpb_park_brake_sensor))
        )
        self._ui.gdpb_disenage_sol_label.delete(0, 100)
        self._ui.gdpb_disenage_sol_label.insert(
            0, "{:.2f}".format(float(self._ui.gdpb_disenage_sol))
        )

    def update_ui_gdhd(self):
        self._ui.gdhd_fwd_sol_label.delete(0, 100)
        self._ui.gdhd_fwd_sol_label.insert(
            0, "{:.2f}".format(float(self._ui.gdhd_fwd_sol))
        )
        self._ui.gdhd_rev_sol_label.delete(0, 100)
        self._ui.gdhd_rev_sol_label.insert(
            0, "{:.2f}".format(float(self._ui.gdhd_rev_sol))
        )
        self._ui.gdhd_ground_speed_label.delete(0, 100)
        self._ui.gdhd_ground_speed_label.insert(
            0, "{:.2f}".format(float(self._ui.gdhd_ground_speed))
        )
        self._ui.gdhd_gear_speed_label.delete(0, 100)
        self._ui.gdhd_gear_speed_label.insert(
            0, "{:.2f}".format(float(self._ui.gdhd_gear_speed))
        )
    ...
    def update_ui_hdhc(self):
        ...
        self._ui.hdhc_lift_prs_volt_pot_label.insert(
            0, int(self._ui.hdhc_lift_prs_volt_pot)
        )
        self._ui.hdhc_feeder_angle_volt_pot_label.delete(0, 100)
        self._ui.hdhc_feeder_angle_volt_pot_label.insert(
            0, int(self._ui.hdhc_feeder_angle_volt_pot)
        )
        self._ui.hdhc_lh_height_tilt_volt_pot_label.delete(0, 100)
        self._ui.hdhc_lh_height_tilt_volt_pot_label.insert(
            0, int(self._ui.hdhc_lh_height_tilt_volt_pot)
        )
        self._ui.hdhc_center_lh_height_volt_pot_label.delete(0, 100)
        self._ui.hdhc_center_lh_height_volt_pot_label.insert(
            0, int(self._ui.hdhc_center_lh_height_volt_pot)
        )
        self._ui.hdhc_center_rh_height_volt_pot_label.delete(0, 100)
        self._ui.hdhc_center_rh_height_volt_pot_label.insert(
            0, int(self._ui.hdhc_center_rh_height_volt_pot)
        )
        self._ui.hdhc_rh_height_tilt_volt_pot_label.delete(0, 100)
        self._ui.hdhc_rh_height_tilt_volt_pot_label.insert(
            0, int(self._ui.hdhc_rh_height_tilt_volt_pot)
        )
        self._ui.hdhc_lateral_position_volt_pot_label.delete(0, 100)
        self._ui.hdhc_lateral_position_volt_pot_label.insert(
            0, int(self._ui.hdhc_lateral_position_volt_pot)
        )

    def update_ui_gdst(self):
        self._ui.gdst_left_track_label.delete(0, 100)
        self._ui.gdst_left_track_label.insert(
            0, "{:.2f}".format(float(self._ui.gdst_leftTensionInput))
        )
        self._ui.gdst_right_track_label.delete(0, 100)
        self._ui.gdst_right_track_label.insert(
            0, "{:.2f}".format(float(self._ui.gdst_rightTensionInput))
        )
        self._ui.gdst_left_front_label.delete(0, 100)
        self._ui.gdst_left_front_label.insert(
            0, "{:.2f}".format(float(self._ui.gdst_leftFrontInput))
        )
        self._ui.gdst_left_rear_label.delete(0, 100)
        self._ui.gdst_left_rear_label.insert(
            0, "{:.2f}".format(float(self._ui.gdst_leftRearInput))
        )
        self._ui.gdst_right_front_label.delete(0, 100)
        self._ui.gdst_right_front_label.insert(
            0, "{:.2f}".format(float(self._ui.gdst_rightFrontInput))
        )
        self._ui.gdst_right_rear_label.delete(0, 100)
        self._ui.gdst_right_rear_label.insert(
            0, "{:.2f}".format(float(self._ui.gdst_rightRearInput))
        )

        ################# JUST FOR TESTING AND COMPARE ##################
        self._ui.gdst_LeftTensionPressure_pot_label.delete(0, 100)
        self._ui.gdst_LeftTensionPressure_pot_label.insert(
            0, "{:.2f}".format(float(self._ui.LeftTensionPressure_pot))
        )
        self._ui.gdst_RightTensionPressure_pot_label.delete(0, 100)
        self._ui.gdst_RightTensionPressure_pot_label.insert(
            0, "{:.2f}".format(float(self._ui.RightTensionPressure_pot))
        )
        self._ui.gdst_LeftFrontDisp_pot_label.delete(0, 100)
        self._ui.gdst_LeftFrontDisp_pot_label.insert(
            0, "{:.2f}".format(float(self._ui.LeftFrontDisp_pot))
        )
        self._ui.gdst_LeftRearDisp_pot_label.delete(0, 100)
        self._ui.gdst_LeftRearDisp_pot_label.insert(
            0, "{:.2f}".format(float(self._ui.LeftRearDisp_pot))
        )
        self._ui.gdst_RightFrontDisp_pot_label.delete(0, 100)
        self._ui.gdst_RightFrontDisp_pot_label.insert(
            0, "{:.2f}".format(float(self._ui.RightFrontDisp_pot))
        )
    ...
    def update_ui_agge(self):
        ...
        self._ui.agge_right_steer_sol_label.insert(
            0, "{:.2f}".format(float(self._ui.agge_steer_right))
        )
        self._ui.agge_left_steer_sol_label.delete(0, 100)
        self._ui.agge_left_steer_sol_label.insert(
            0, "{:.2f}".format(float(self._ui.agge_steer_left))
        )
    ...
    def update_ui_rrts(self):
        ...
        self._ui.rrts_rocktrap_open_sol_label.insert(
            0, "{:.2f}".format(float(self._ui.rrts_rocktrap_open))
        )
        self._ui.rrts_rocktrap_close_sol_label.delete(0, 100)
        self._ui.rrts_rocktrap_close_sol_label.insert(
            0, "{:.2f}".format(float(self._ui.rrts_rocktrap_close))
        )
