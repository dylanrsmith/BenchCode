...
class generate_ui():
    ...
    def generate_spn_ui(self):
        ...
        for i in range(len(self._ge.dig_ip_spn)):
            ...
            self._ge.dig_ip_button[i] = tk.Button(self._ge.dig_ip_frame, height=1, width=4, bd=6, fg="black", font=(
                'Geneva', 6), bg="Green", command=partial(self.ui_call.dig_ip_callback, i))

            self._ge.dig_ip_option[i] = tk.OptionMenu(self._ge.dig_ip_frame, self._ge.dig_ip_option_var[i],
                                                      *self._ge.dig_ip_options, command=partial(self.ui_call.output_send, self._ge.dig_ip_spn[i]))

            label = tk.Label(self._ge.dig_ip_frame,
                             text=self._ge.dig_ip_name[i], bg="azure3", width=55)
        ...
        for i in range(len(self._ge.dig_op_spn)):
            ...
            self._ge.dig_op_button[i] = tk.Button(
                self._ge.dig_op_frame, height=1, width=4, bd=6, fg="black", font=('Geneva', 6), bg="Green")
            label = tk.Label(self._ge.dig_op_frame,
                             text=self._ge.dig_op_name[i], bg="azure3", width=50)
            if 0 <= i < 31:
                row = i
                column = 1
            elif 31 <= i < 62:
        ...
        for i in range(len(self._ge.vol_ip_spn)):  # length = 58
            ...
            label = tk.Label(self._ge.volt_ip_frame,
                             text=self._ge.vol_ip_name[i], bg="azure3", width=55)
            self._ge.volt_label[i] = tk.Entry(self._ge.volt_ip_frame, bd=2, validate='key', width=6, font=(
                'courier', 10), textvariable=self._ge.volt_string[i])
            self._ge.volt_button[i] = tk.Button(self._ge.volt_ip_frame, height=1, width=11, bd=8, fg="white", font=(
                'Geneva', 6), text="Update", bg="Steel Blue", command=partial(self.ui_call.buttonVolt, i))
            self._ge.volt_toggle[i] = tk.Button(self._ge.volt_ip_frame, height=1, width=4, bd=6, fg="black", font=(
                'Geneva', 6), bg="Red", command=partial(self.ui_call.voltToggle, i))
        ...
        for i in range(len(self._ge.pwm_ip_spn)):
            ...
            label = tk.Label(self._ge.pwm_ip_frame,
                             text=self._ge.pwm_ip_name[i], bg="azure3", width=55)
            self._ge.pwm_ip_label[i] = tk.Entry(self._ge.pwm_ip_frame, bd=2, validate='key', width=6, font=(
                'courier', 10), textvariable=self._ge.pwm_ip_string[i])

            # Create a Button widget for update
            self._ge.pwm_ip_button[i] = tk.Button(self._ge.pwm_ip_frame, height=1, width=11, bd=8, fg="white", font=(
                'Geneva', 6), text="Update", bg="Steel Blue", command=partial(self.ui_call.buttonPwmip, i))
            label.grid(row=i, column=0)
            ...
            self._ge.pwm_ip_toggle[i] = tk.Button(self._ge.pwm_ip_frame, height=1, width=4, bd=6, fg="black", font=(
                'Geneva', 6), bg="Green", command=partial(self.ui_call.pwmToggle, i))
        ...
        for i in range(len(self._ge.pwm_op_spn)):
            ...
            label = tk.Label(self._ge.pwm_op_frame,
                             text=self._ge.pwm_op_name[i], bg="azure3", width=55)
            self._ge.pwm_op_label[i] = tk.Entry(
                self._ge.pwm_op_frame, bd=2, validate='key', width=6, font=('courier', 10))
            label.grid(row=i, column=0)
        ...
        for i in range(len(self._ge.fq_ip_spn)):
            ...
            label = tk.Label(self._ge.freq_ip_frame,
                             text=self._ge.fq_ip_name[i], bg="azure3", width=55, )
            self._ge.freq_label[i] = tk.Entry(self._ge.freq_ip_frame, bd=2, validate='key', width=6, font=(
                'courier', 10), textvariable=self._ge.freq_string[i])
            self._ge.freq_button[i] = tk.Button(self._ge.freq_ip_frame, height=1, width=11, bd=8, fg="white", font=(
                'Geneva', 6), text="Update", bg="Steel Blue", command=partial(self.ui_call.buttonFreq, i))
            label.grid(row=i, column=0)
            self._ge.freq_label[i].grid(row=i, column=1)
            self._ge.freq_button[i].grid(row=i, column=2)
            self._ge.freq_label[i].insert(0, '0')
            self._ge.freq_toggle[i] = tk.Button(self._ge.freq_ip_frame, height=1, width=4, bd=6, fg="black", font=(
                'Geneva', 6), bg="Green", command=partial(self.ui_call.freqToggle, i))
        ...
        for i in range(len(self._ge.pulse_spn)):
            ...
            label = tk.Label(self._ge.pulse_frame,
                             text=self._ge.pulse_name[i], bg="azure3", width=55)
            self._ge.pulse_label[i] = tk.Entry(self._ge.pulse_frame, bd=2, validate='key', width=6, font=(
                'courier', 10), textvariable=self._ge.pulse_string[i])
            self._ge.button_pulse[i] = tk.Button(self._ge.pulse_frame, height=1, width=11, bd=8, fg="white", font=(
                'Geneva', 6), text="Update", bg="Steel Blue", command=partial(self.ui_call.buttonPulse, i))
            label.grid(row=i, column=0)
            self._ge.pulse_label[i].grid(row=i, column=1)
            self._ge.button_pulse[i].grid(row=i, column=2)
            self._ge.pulse_label[i].insert(0, '0')
            self._ge.pulse_toggle[i] = tk.Button(self._ge.pulse_frame, height=1, width=4, bd=6, fg="black", font=(
                'Geneva', 6), bg="Green", command=partial(self.ui_call.pulseToggle, i))
    ...
    def get_sim_mode(self):
        ...
        if self._ge.SimMode == 0:
            all_widgets = list(itertools.chain(self._ge.dig_ip_option, self._ge.open_option, self._ge.volt_toggle,
                               self._ge.pwm_ip_toggle, self._ge.freq_toggle, self._ge.pulse_toggle, self._ge.actuator_load, self._ge.actuator_set))
    ...
    def generate_open_ui(self):
        ...
        for i in range(len(self._ge.dig_ip_spn)):
            ...
            try:
                label = tk.Label(
                    self._ge.open_frame, text=self._ge.dig_ip_name[i], bg="azure3", width=55)
                self._ge.open_button[i] = tk.Button(self._ge.open_frame, text='Update', fg="white", bg="Steel Blue", command=partial(
                    self.ui_call.open_button_callback, self._ge.dig_ip_spn[i]))  # TODO, command=self.ui_call.callback) #Might have to make button list

                # Check each SPN value of column D in config_sheet

                if parse == 'B':
                    self._ge.open_option[i] = tk.OptionMenu(self._ge.open_frame, self._ge.open_option_var[i],
                                                            *self._ge.battery_option, command=partial(self.ui_call.output_send, self._ge.dig_ip_spn[i]))
                elif parse == 'G':
                    self._ge.open_option[i] = tk.OptionMenu(self._ge.open_frame, self._ge.open_option_var[i],
                                                            *self._ge.ground_option, command=partial(self.ui_call.output_send, self._ge.dig_ip_spn[i]))
                elif parse == 'Both':
                    self._ge.open_option[i] = tk.OptionMenu(self._ge.open_frame, self._ge.open_option_var[i],
                                                            *self._ge.both_option, command=partial(self.ui_call.output_send, self._ge.dig_ip_spn[i]))
    ...
    def generate_actuator_ui(self):
        ...
        for i in range(len(self._ge.actuator_dict)):
            ...
            try:
                if i == 0:
                    tk.Label(self._ge.actuator_frame, text="Load",
                             width=20).grid(row=i, column=1)
                    tk.Label(self._ge.actuator_frame, text="Actual Position", width=20).grid(
                        row=i, column=2)
                    tk.Label(self._ge.actuator_frame, text="Set Position",
                             width=20).grid(row=i, column=3)
                else:
                    label = tk.Label(
                        self._ge.actuator_frame, text=self._ge.actuator_dict[i], bg="azure3", width=15)
                    label.grid(row=i, column=0)
                    ...
                    self._ge.actuator_btn[i] = tk.Button(
                        self._ge.actuator_frame, text="Update", fg="white", bg="Steel Blue")  # TODO,command=)
    ...
    def generate_driveline_ui(self):
        for i in range(len(self._ge.sp_name)):
            ...
            label = tk.Label(self._ge.driveline_frame,
                             text=self._ge.sp_name[i], bg="azure3", width=40)
            label.grid(row=i, column=0)
        ...
        label = tk.Label(self._ge.driveline_frame,
                         text='Eng Spd', bg="azure3", width=40)
        label.grid(row=2, column=3)

        eng_spd_entry = tk.Entry(
            self._ge.driveline_frame, textvariable=self._ge.eng_spd, font=('calibre', 10, 'normal'))
        ...
        sub_btn = tk.Button(self._ge.driveline_frame, text='Update',
                            fg="white", bg="Steel Blue", command=self.ui_call.dv_eng_spd)
        sub_btn.grid(row=2, column=6)

        label = tk.Label(self._ge.driveline_frame,
                         text='chopper type', bg="azure3", width=40)
        menu = tk.OptionMenu(self._ge.driveline_frame, self._ge.chopper_type_var, str(
            'IC'), str('HHMC'), command=self.ui_call.chopper_type_callback)
        label.grid(row=4, column=3)
        self._ge.chopper_type_var.set('HHMC')
        menu.grid(row=4, column=4)

        label = tk.Label(self._ge.driveline_frame,
                         text='IC gear', bg="azure3", width=40)
        menu = tk.OptionMenu(self._ge.driveline_frame, self._ge.IC_gear, str(
            'Gear0'), str('Gear1'), command=self.ui_call.IC_gear_callback)
        label.grid(row=5, column=3)
        self._ge.IC_gear.set('Gear1')
        menu.grid(row=5, column=4)

        label = tk.Label(self._ge.driveline_frame,
                         text='HHMC gear', bg="azure3", width=40)
        menu = tk.OptionMenu(self._ge.driveline_frame, self._ge.HHMC_gear, str(
            'Gear0'), str('Gear1'), command=self.ui_call.HHMC_gear_callback)
        ...
        label = tk.Label(self._ge.driveline_frame,
                         text='feeder type', bg="azure3", width=40)
        menu = tk.OptionMenu(self._ge.driveline_frame, self._ge.feeder_type, str(
            'fixed'), str('variable'), command=self.ui_call.feeder_callback)
        label.grid(row=8, column=3)
        self._ge.feeder_type.set('variable')
        menu.grid(row=8, column=4)

        label = tk.Label(self._ge.driveline_frame,
                         text='unload rate', bg="azure3", width=40)
        menu = tk.OptionMenu(self._ge.driveline_frame, self._ge.unload_rate, str(
            'slow_unload'), str('fast_unload'), command=self.ui_call.unload_type_callback)
        label.grid(row=9, column=3)
        self._ge.unload_rate.set('fast_unload')
        menu.grid(row=9, column=4)

        label = tk.Label(self._ge.driveline_frame,
                         text='dfr gear', bg="azure3", width=40)
        menu = tk.OptionMenu(self._ge.driveline_frame, self._ge.rotor_gear_box_var, str('rotor_gear_0'), str(
            'rotor_gear_1'), str('rotor_gear_2'), command=self.ui_call.rotor_gear_box_callback)
        label.grid(row=10, column=3)
        self._ge.rotor_gear_box_var.set('rotor_gear_2')
        menu.grid(row=10, column=4)

        label = tk.Label(self._ge.driveline_frame,
                         text='feedroll slip', bg="azure3", width=20)
        label.grid(row=11, column=3)
        w4 = tk.Scale(self._ge.driveline_frame, from_=0, to=100,
                      orient=tk.HORIZONTAL, variable=self._ge.feed_roll_var)
        w4.set(self._ge.feed_roll)
        w4.grid(row=11, column=4)
        b2 = tk.Button(self._ge.driveline_frame, text='Update', fg="white",
    ...
    def generate_clrm_ui(self):
        ...
        label_frame_clrm = tk.LabelFrame(
            self._ge.plant_model_ucm1_frame, text='CLRM')
        label_frame_clrm.pack(expand='yes', fill='both')

        label = tk.Label(label_frame_clrm, text='Plant enable',
                         bg="azure3", width=20)
        ...
        label = tk.Label(label_frame_clrm, text='clrm period',
                         bg="azure3", width=20)
        label.grid(row=2, column=1)
        w1 = tk.Scale(label_frame_clrm, from_=0, to=500,
                      orient=tk.HORIZONTAL, variable=self._ge.period_slide)
        w1.set(self._ge.period)
        w1.grid(row=2, column=2)

        label = tk.Label(label_frame_clrm, text='clrm pulse',
                         bg="azure3", width=20)
        label.grid(row=3, column=1)
        w2 = tk.Scale(label_frame_clrm, from_=0, to=100,
                      orient=tk.HORIZONTAL, variable=self._ge.pulse_slide)
        w2.set(self._ge.pulse)
        w2.grid(row=3, column=2)

        label = tk.Label(label_frame_clrm, text='clrm degree',
                         bg="azure3", width=20)
        label.grid(row=4, column=1)
        w3 = tk.Scale(label_frame_clrm, from_=0, to=360,
                      orient=tk.HORIZONTAL, variable=self._ge.degree_slide)
        w3.set(self._ge.degree)
        w3.grid(row=4, column=2)

        b1 = tk.Button(label_frame_clrm, text='Update', fg="white",
                       bg="Steel Blue", command=self.ui_call.clrm_callback)
        b1.grid(row=3, column=3)

        label = tk.Label(label_frame_clrm,
                         text='Tail Sensor spd', bg="azure3", width=20)
        label.grid(row=6, column=1)
        self._ge.clrm_label = tk.Entry(
            label_frame_clrm, font=('calibre', 10, 'normal'))
    ...
    def generate_ui_hdhr(self):
        ...
        # This will create a LabelFrame
        label_frame_hdhr = tk.LabelFrame(
            self._ge.plant_model_ucm1_frame, text='HDHR')
        label_frame_hdhr.pack(expand='yes', fill='both')

        label = tk.Label(label_frame_hdhr, text='Plant enable',
                         bg="azure3", width=20)
        label.grid(row=1, column=1)
        ...
        label = tk.Label(label_frame_hdhr, text='header type',
                         bg="azure3", width=20)
        ...
        label = tk.Label(label_frame_hdhr, text='hdr typ volt',
                         bg="azure3", width=20)
        label.grid(row=3, column=1)
        ...
        label = tk.Label(label_frame_hdhr, text='hdr ext1 volt',
                         bg="azure3", width=20)
        label.grid(row=4, column=1)
        ...
        label = tk.Label(label_frame_hdhr, text='hdr ext2 volt',
                         bg="azure3", width=20)
    ...
    def generate_ui_hdfn(self):
        ...
        # This will create a LabelFrame
        label_frame_hdfn = tk.LabelFrame(
            self._ge.plant_model_ucm1_frame, text='HDFN')
        label_frame_hdfn.pack(expand='yes', fill='both')

        label = tk.Label(label_frame_hdfn, text='hor enable',
                         bg="azure3", width=20)
        label.grid(row=1, column=1)
        ...
        label = tk.Label(label_frame_hdfn, text='ver enable',
                         bg="azure3", width=20)
        label.grid(row=2, column=1)
        ...
        label = tk.Label(label_frame_hdfn, text='vari enable',
                         bg="azure3", width=20)
        label.grid(row=3, column=1)
        ...
        label = tk.Label(label_frame_hdfn, text='hor install',
                         bg="azure3", width=20)
        ...
        label = tk.Label(label_frame_hdfn, text='ver install',
                         bg="azure3", width=20)
        label.grid(row=2, column=3)
        ...
        label = tk.Label(label_frame_hdfn, text='vari install',
                         bg="azure3", width=20)
        ...
        label = tk.Label(label_frame_hdfn, text='reel up sol',
                         bg="azure3", width=20)
        ...
        label = tk.Label(label_frame_hdfn, text='reel down sol',
                         bg="azure3", width=20)
        ...
        label = tk.Label(label_frame_hdfn, text='reel fore sol',
                         bg="azure3", width=20)
        ...
        label = tk.Label(label_frame_hdfn, text='reel aft sol',
                         bg="azure3", width=20)
        ...
        label = tk.Label(label_frame_hdfn, text='swap 1',
                         bg="azure3", width=20)
        ...
        label = tk.Label(label_frame_hdfn, text='swap 2',
                         bg="azure3", width=20)
        ...
        label = tk.Label(label_frame_hdfn, text='swap 3',
                         bg="azure3", width=20)
        ...
        label = tk.Label(label_frame_hdfn, text='vari pos',
                         bg="azure3", width=20)
        label.grid(row=7, column=3)
        ...
        label = tk.Label(label_frame_hdfn, text='hor pos',
                         bg="azure3", width=20)
        ...
        label = tk.Label(label_frame_hdfn, text='ver pos',
                         bg="azure3", width=20)
        label.grid(row=8, column=3)
        ...
        label = tk.Label(label_frame_hdfn, text='reel enable',
                         bg="azure3", width=20)
        ...
        label = tk.Label(label_frame_hdfn, text='ffa enable',
                         bg="azure3", width=20)
        label.grid(row=9, column=3)
        ...
        label = tk.Label(label_frame_hdfn, text='reel sol',
                         bg="azure3", width=20)
        ...
        label = tk.Label(label_frame_hdfn, text='ffa sol fore',
                         bg="azure3", width=20)
        ...
        label = tk.Label(label_frame_hdfn, text='ffa install',
                         bg="azure3", width=20)
        ...
        label = tk.Label(label_frame_hdfn, text='reel pulse',
                         bg="azure3", width=20)
        ...
        label = tk.Label(label_frame_hdfn, text='reel rpm',
                         bg="azure3", width=20)
        ...
        label = tk.Label(label_frame_hdfn, text='ffa rpm',
                         bg="azure3", width=20)
        label.grid(row=12, column=3)
        ...
        label = tk.Label(label_frame_hdfn, text='ffa sol aft',
                         bg="azure3", width=20)
    ...
    def generate_ui_agge(self):
        ...
        label = tk.Label(label_frame_agge, text='Steering Manual Override', bg="azure3", width=20)
        label.grid(row=2, column=1)

        self._ge.agge_steering_wheel_override = tk.Button(label_frame_agge, height=1, width=4, bd=6, fg="black",
                                                font=('Geneva', 6),
                                                bg="Green", command=self.ui_call.agge_steering_override)
        self._ge.agge_steering_wheel_override.grid(row=2, column=2)

        label = tk.Label(label_frame_agge, text='Steering_W Motion Sensor', bg="azure3", width=20)
        label.grid(row=2, column=3)
        self._ge.agge_wheel_label = tk.Entry(label_frame_agge, font=('calibre', 10, 'normal'))
        self._ge.agge_wheel_label.insert(0, 0)
        self._ge.agge_wheel_label.grid(row=2, column=4)

        label = tk.Label(label_frame_agge, text='Steering Wheel State', bg="azure3", width=20)
        label.grid(row=3, column=1)

        sub_btn = tk.Button(label_frame_agge, text='Left', fg="white", bg="Steel Blue", width=20,
                                command=self.ui_call.agge_steering_left_callback)
        sub_btn.grid(row=3, column=2)
        sub_btn = tk.Button(label_frame_agge, text='Center', fg="white", bg="Steel Blue", width=20,
                            command=self.ui_call.agge_steering_center_callback)
        sub_btn.grid(row=3, column=3)
        sub_btn = tk.Button(label_frame_agge, text='Right', fg="white", bg="Steel Blue", width=20,
                            command=self.ui_call.agge_steering_right_callback)
        sub_btn.grid(row=3, column=4)

        label = tk.Label(label_frame_agge, text='Rear Axle Angle', bg="azure3", width=20)
        label.grid(row=4, column=1)
        ...
        label = tk.Label(label_frame_agge, text='Right Steer Sol', bg="azure3", width=20)
        label.grid(row=5, column=1)
        self._ge.agge_right_steer_sol_label = tk.Entry(label_frame_agge, font=('calibre', 10, 'normal'))
        ...
        label.grid(row=5, column=3)
        self._ge.agge_left_steer_sol_label = tk.Entry(label_frame_agge, font=('calibre', 10, 'normal'))
    ...
    def generate_ui_rrts(self):
        ...
        label.grid(row=1, column=1)
        c1 = tk.Checkbutton(label_frame_rrts, text='rrts_enable', variable=self._ge.rrts_enable_var,
                            onvalue=int(1), offvalue=int(0), command=self.ui_call.rrts_callback)
        c1.grid(row=1, column=2)
        self._ge.rrts_enable_var.set(1)

        label = tk.Label(label_frame_rrts, text='Rocktrap Open Switch', bg="azure3", width=20)
        label.grid(row=2, column=1)
        self._ge.rrts_rocktrap_open_switch = tk.Button(label_frame_rrts, height=1, width=4, bd=6, fg="black",
                                                          font=('Geneva', 6),
                                                          bg="Green", command=self.ui_call.rrts_rocktrap_open_sw_callback)
        self._ge.rrts_rocktrap_open_switch.grid(row=2, column=2)
        label = tk.Label(label_frame_rrts, text='Rocktrap Close Switch', bg="azure3", width=20)
        label.grid(row=2, column=3)
        self._ge.rrts_rocktrap_close_switch = tk.Button(label_frame_rrts, height=1, width=4, bd=6, fg="black",
                                                          font=('Geneva', 6),
                                                          bg="Green", command=self.ui_call.rrts_rocktrap_close_sw_callback)
        self._ge.rrts_rocktrap_close_switch.grid(row=2, column=4)

        label = tk.Label(label_frame_rrts, text='Rocktrap Open Sol', bg="azure3", width=20)
        label.grid(row=3, column=1)
        self._ge.rrts_rocktrap_open_sol_label = tk.Entry(label_frame_rrts, font=('calibre', 10, 'normal'))
        self._ge.rrts_rocktrap_open_sol_label.grid(row=3, column=2)
        self._ge.rrts_rocktrap_open_sol_label.insert(0, '0')
        label = tk.Label(label_frame_rrts, text='Rocktrap Close Sol', bg="azure3", width=20)
        label.grid(row=3, column=3)
        self._ge.rrts_rocktrap_close_sol_label = tk.Entry(label_frame_rrts, font=('calibre', 10, 'normal'))
    ...
    def generate_ghcv_ui(self):
        ...
        # This will create a LabelFrame
        label_frame_ghcv = tk.LabelFrame(
            self._ge.plant_model_ucm2_frame, text='GHCV')
        label_frame_ghcv.pack(expand='yes', fill='both')

        label = tk.Label(label_frame_ghcv, text='Plant enable',
                         bg="azure3", width=20)
        label.grid(row=1, column=1)
        ...
        label = tk.Label(label_frame_ghcv, text='open error',
                         bg="azure3", width=20)
        label.grid(row=2, column=1)
        ...
        label = tk.Label(label_frame_ghcv, text='close error',
                         bg="azure3", width=20)
        label.grid(row=3, column=1)
        ...
        label = tk.Label(label_frame_ghcv, text='Time to close',
                         bg="azure3", width=20)
        label.grid(row=4, column=1)
        ...
        label = tk.Label(label_frame_ghcv, text='Time to open',
                         bg="azure3", width=20)
        label.grid(row=5, column=1)
        ...
        label = tk.Label(label_frame_ghcv,
                         text='cover open sol', bg="azure3", width=20)
        cover_open_entry = tk.Entry(
            label_frame_ghcv, textvariable=self._ge.cover_open, font=('calibre', 10, 'normal'))
        self._ge.cover_open.set(0)
        sub_btn = tk.Button(label_frame_ghcv, text='Update', fg="white",
                            bg="Steel Blue", command=self.ui_call.ghcv_callback)
        label.grid(row=6, column=1)
        cover_open_entry.grid(row=6, column=2)
        sub_btn.grid(row=6, column=3)

        label = tk.Label(label_frame_ghcv,
                         text='cover close sol', bg="azure3", width=20)
        cover_close_entry = tk.Entry(
            label_frame_ghcv, textvariable=self._ge.cover_closed, font=('calibre', 10, 'normal'))
        ...
        label = tk.Label(label_frame_ghcv,
                         text='sensor cover open', bg="azure3", width=20)
        label.grid(row=8, column=1)
        self._ge.open_label = tk.Entry(
            label_frame_ghcv, font=('calibre', 10, 'normal'))
        self._ge.open_label.grid(row=8, column=2)
        self._ge.open_label.insert(0, self._ge.cover_open_sensor)

        label = tk.Label(label_frame_ghcv,
                         text='sensor cover close', bg="azure3", width=20)
        label.grid(row=9, column=1)
    ...
    def generate_ui_rsch(self):
        label_frame_rsch = tk.LabelFrame(
            self._ge.plant_model_ucm2_frame, text='RSCH')
        label_frame_rsch.pack(expand='yes', fill='both')

        label = tk.Label(label_frame_rsch, text='Plant enable',
                         bg="azure3", width=20)
        label.grid(row=1, column=1)
        ...
        label = tk.Label(label_frame_rsch, text='chopper type',
                         bg="azure3", width=20)
        ...
        label = tk.Label(label_frame_rsch, text='crop_load',
                         bg="azure3", width=20)
        label.grid(row=4, column=1)
        w1 = tk.Scale(label_frame_rsch, from_=0, to=100,
                      orient=tk.HORIZONTAL, variable=self._ge.load)
        w1.set(self._ge.crop_load_rsch)
        w1.grid(row=4, column=2)

        b1 = tk.Button(label_frame_rsch, text='Update', fg="white",
                       bg="Steel Blue", command=self.ui_call.rsch_callback)
        b1.grid(row=4, column=3)

        label = tk.Label(label_frame_rsch, text='Chopper spd',
                         bg="azure3", width=20)
        label.grid(row=6, column=1)
        self._ge.rsch_label = tk.Entry(
            label_frame_rsch, font=('calibre', 10, 'normal'))
    ...
    def generate_clfn_ui(self):
        ...
        # This will create a LabelFrame
        label_frame_clfn = tk.LabelFrame(
            self._ge.plant_model_ucm2_frame, text='CLFN')
        label_frame_clfn.pack(expand='yes', fill='both')

        label = tk.Label(label_frame_clfn, text='Plant enable',
                         bg="azure3", width=20)
        label.grid(row=1, column=1)
        ...
        label = tk.Label(label_frame_clfn,
                         text='clfn sol drive', bg="azure3", width=20)
        clfn_sol_entry = tk.Entry(
            label_frame_clfn, textvariable=self._ge.clfn_pwm_var, font=('calibre', 10, 'normal'))
        ...
        label = tk.Label(label_frame_clfn, text='clfn RPM',
                         bg="azure3", width=20)
        label.grid(row=3, column=1)
    ...
    def generate_ui_ghts(self):
        ...
        # This will create a LabelFrame
        label_frame_ghts = tk.LabelFrame(
            self._ge.plant_model_ucm3_frame, text='GHTS')
        label_frame_ghts.pack(expand='yes', fill='both')

        label = tk.Label(label_frame_ghts, text='Plant enable',
                         bg="azure3", width=20)
        label.grid(row=1, column=1)
        ...
        label = tk.Label(label_frame_ghts,
                         text='Pos sensor enable', bg="azure3", width=20)
        label.grid(row=2, column=1)
        ...
        label = tk.Label(label_frame_ghts,
                         text='Cradle sensor enable', bg="azure3", width=20)
        label.grid(row=3, column=1)
        ...
        label = tk.Label(label_frame_ghts, text='Current',
                         bg="azure3", width=20)
        label.grid(row=4, column=1)
        ...
        label = tk.Label(label_frame_ghts, text='Position',
                         bg="azure3", width=20)
        ...
        label = tk.Label(label_frame_ghts, text='Position volt',
                         bg="azure3", width=20)
        ...
        self._ge.cradle_button = tk.Button(
            label_frame_ghts, height=1, width=4, bd=6, fg="black", font=('Geneva', 6), bg="Green", )
        label = tk.Label(label_frame_ghts, text='Cradle sensor',
                         bg="azure3", width=20)
        label.grid(row=4, column=4)
        self._ge.cradle_button.grid(row=4, column=5)

        label = tk.Label(label_frame_ghts, text='swing in sol',
                         bg="azure3", width=20)
        swing_in_entry = tk.Entry(label_frame_ghts, textvariable=self._ge.ghts_input_solenoid,
                                  font=('calibre', 10, 'normal'))
        self._ge.ghts_input_solenoid.set(0)
        sub_btn = tk.Button(label_frame_ghts, text='Update', fg="white",
                            bg="Steel Blue", command=self.ui_call.ghts_callback)
        label.grid(row=5, column=1)
        swing_in_entry.grid(row=5, column=2)
        sub_btn.grid(row=5, column=3)

        label = tk.Label(label_frame_ghts, text='swing out sol',
                         bg="azure3", width=20)
        ...
        label = tk.Label(label_frame_ghts,
                         text='travel limiter', bg="azure3", width=20)
        label.grid(row=6, column=1)
        w3 = tk.Scale(label_frame_ghts, from_=0, to=100,
                      orient=tk.HORIZONTAL, variable=self._ge.ghts_travel_limit)
    ...
    def generate_ui_rsck(self):
        ...
        label.grid(row=2, column=1)
        self._ge.rsck_label_in_current = tk.Entry(label_frame_rsck, font=('calibre', 10, 'normal'))
        self._ge.rsck_label_in_current.grid(row=2, column=2)
        self._ge.rsck_label_in_current.insert(0, 0)

        label = tk.Label(label_frame_rsck, text='High speed Current(mA)', bg="azure3", width=20)
        label.grid(row=3, column=1)
        ...
        label = tk.Label(label_frame_rsck, text='OUT Current(mA)', bg="azure3", width=20)
        label.grid(row=2, column=4)
        self._ge.rsck_label_out_current = tk.Entry(label_frame_rsck, font=('calibre', 10, 'normal'))
    ...
    def generate_ui_ghps(self):
        ...
        label_frame_ghps = tk.LabelFrame(
            self._ge.plant_model_ucm3_frame, text='GHPS',)
        label_frame_ghps.pack(expand='yes', fill='both')

        label = tk.Label(label_frame_ghps, text='Plant enable',
                         bg="azure3", width=20)
        label.grid(row=1, column=1)
        ...
        label = tk.Label(label_frame_ghps, text='Current',
                         bg="azure3", width=20)
        label.grid(row=2, column=1)
        ...
        label = tk.Label(label_frame_ghps,
                         text='h bridge current', bg="azure3", width=20)
        h_bridge_curr_entry = tk.Entry(label_frame_ghps, textvariable=self._ge.ghps_h_curr_var,
                                       font=('calibre', 10, 'normal'))
        self._ge.ghps_h_curr_var.set(0)
        sub_btn = tk.Button(label_frame_ghps, text='Update', fg="white",
                            bg="Steel Blue", command=self.ui_call.ghps_callback)
        label.grid(row=3, column=1)
        h_bridge_curr_entry.grid(row=3, column=2)
        sub_btn.grid(row=3, column=3)

        label = tk.Label(label_frame_ghps, text='h bridhe PWM',
                         bg="azure3", width=20)
        ...
        label = tk.Label(label_frame_ghps, text='bridge enable',
                         bg="azure3", width=20)
        label.grid(row=4, column=1)
        ...
        self._ge.ghps_bridge_button = tk.Button(label_frame_ghps, height=1, width=4, bd=6, fg="black", font=('Geneva', 6),
                                                bg="Green", )
        label = tk.Label(label_frame_ghps, text='bridge status',
                         bg="azure3", width=20)
        label.grid(row=4, column=4)
        self._ge.ghps_bridge_button.grid(row=4, column=5)

        label = tk.Label(label_frame_ghps, text='Position',
                         bg="azure3", width=20)
        label.grid(row=6, column=1)
        ...
        label = tk.Label(label_frame_ghps, text='sensor volt',
                         bg="azure3", width=20)
        label.grid(row=6, column=4)
    ...
    def generate_ui_thcc(self):
        ...
        label = tk.Label(label_frame_thcc, text='Time Taken(seconds)', bg="azure3", width=20)
        label.grid(row=1, column=4)
        self._ge.thcc_time_taken_label = tk.Entry(label_frame_thcc, font=('calibre', 10, 'normal'))
        ...
        c1 = tk.Checkbutton(label_frame_thcc, text='pos_sensor_link', variable=self._ge.thcc_sensor_link_var,
                    onvalue=int(1), offvalue=int(0), command=self.ui_call.thcc_callback)
        ...
        label.grid(row=2, column=4)
        self._ge.thcc_pot_volt_label = tk.Entry(label_frame_thcc, font=('calibre', 10, 'normal'))
        self._ge.thcc_pot_volt_label.grid(row=2, column=5)
        self._ge.thcc_pot_volt_label.insert(0, self._ge.thcc_pot_volt)

        label = tk.Label(label_frame_thcc, text='Breakaway Status', bg="azure3", width=20)
        label.grid(row=3, column=1)
        self._ge.thcc_breakaway_status = tk.Label(label_frame_thcc, text='Engaged', width=20) 
        self._ge.thcc_breakaway_status.grid(row=3, column=2)                                  
        self._ge.thcc_breakaway_button = tk.Button(label_frame_thcc, height=1, width=4, bd=6, fg="black",
                                                font=('Geneva', 6),
                                                bg="Green", command=self.ui_call.thcc_breakaway)
        self._ge.thcc_breakaway_button.grid(row=3, column=3)
        
    def generate_ui_gdpb(self):
        # This will create a LabelFrame
        label_frame_gdpb = tk.LabelFrame(self._ge.plant_model_ucm3_frame, text='GDPB',)
        label_frame_gdpb.pack(expand='yes', fill='both')
        label = tk.Label(label_frame_gdpb, text='Plant enable', bg="azure3", width=20)
        label.grid(row=1, column=1)
        c1 = tk.Checkbutton(label_frame_gdpb, text='gdpb_enable', variable=self._ge.gdpb_enable_var,
                            onvalue=int(1), offvalue=int(0), command=self.ui_call.gdpb_callback)
        c1.grid(row=1, column=2)
        self._ge.gdpb_enable_var.set(1)

        label = tk.Label(label_frame_gdpb, text='Park Brake Disengage Sol', bg="azure3", width=20)
        label.grid(row=2, column=1)
        self._ge.gdpb_disenage_sol_label = tk.Entry(label_frame_gdpb, font=('calibre', 10, 'normal'))
        self._ge.gdpb_disenage_sol_label.grid(row=2, column=2)
        self._ge.gdpb_disenage_sol_label.insert(0, self._ge.gdpb_disenage_sol)

        c1 = tk.Checkbutton(label_frame_gdpb, text='Link to PB sol', variable=self._ge.gdpb_link_to_sensor_var,
                            onvalue=int(1), offvalue=int(0), command=self.ui_call.gdpb_callback)
        c1.grid(row=3, column=5)
        self._ge.gdpb_link_to_sensor_var.set(1)

        label = tk.Label(label_frame_gdpb, text='Park Brake Sensor(V)', bg="azure3", width=20)
        label.grid(row=3, column=1)

        self._ge.gdpb_park_brake_sensor_label = tk.Entry(label_frame_gdpb, font=('calibre', 10, 'normal'))
        ...
        w3 = tk.Scale(label_frame_gdpb, from_=0, to=4.6, resolution=0.01, orient=tk.HORIZONTAL,
                      variable=self._ge.gdpb_park_brake_sensor_var)
        w3.set(self._ge.gdpb_park_brake_sensor)
        w3.grid(row=3, column=3)

        sub_btn = tk.Button(label_frame_gdpb, text='Update', fg="white", bg="Steel Blue",
                             command=self.ui_call.gdpb_callback)
        sub_btn.grid(row=3, column=4)
      
    def generate_ui_gdhd(self):
        # This will create a LabelFrame
        label_frame_gdhd = tk.LabelFrame(self._ge.plant_model_ucm3_frame, text='GDHD',)
        label_frame_gdhd.pack(expand='yes', fill='both')
        label = tk.Label(label_frame_gdhd, text='Plant enable', bg="azure3", width=20)
        label.grid(row=1, column=1)
        c1 = tk.Checkbutton(label_frame_gdhd, text='gdhd_enable', variable=self._ge.gdhd_enable_var,
                            onvalue=int(1), offvalue=int(0), command=self.ui_call.gdhd_callback)
        c1.grid(row=1, column=2)
        self._ge.gdhd_enable_var.set(1)
        
        label = tk.Label(label_frame_gdhd, text='gear', bg="azure3", width=20)
        menu = tk.OptionMenu(label_frame_gdhd, self._ge.gear, str('Gear0'), str('Gear1'), str('Gear2'),
        ...
        label.grid(row=2, column=1)
        self._ge.gdhd_rev_sol_label = tk.Entry(label_frame_gdhd, font=('calibre', 10, 'normal'))
        ...
        label.grid(row=2, column=4)
        self._ge.gdhd_fwd_sol_label = tk.Entry(label_frame_gdhd, font=('calibre', 10, 'normal'))
        self._ge.gdhd_fwd_sol_label.grid(row=2, column=5)
        self._ge.gdhd_fwd_sol_label.insert(0, self._ge.gdhd_fwd_sol)
        
        label = tk.Label(label_frame_gdhd, text='Pump Displacement(cc)', bg="azure3", width=20)
        label.grid(row=3, column=1)
        pump_displace_entry = tk.Entry(label_frame_gdhd, textvariable=self._ge.gdhd_pump_displacement_var, font=('calibre', 10, 'normal'))
        self._ge.gdhd_pump_displacement_var.set(self._ge.gdhd_max_pump_displacement)
        pump_displace_entry.grid(row=3, column=2)
        sub_btn = tk.Button(label_frame_gdhd, text='Update', fg="white", bg="Steel Blue",
                             command=self.ui_call.gdhd_callback)
        sub_btn.grid(row=3, column=3)
        
        label = tk.Label(label_frame_gdhd, text='Motor Displacement(cc)', bg="azure3", width=20)
        label.grid(row=3, column=4)
        motor_displace_entry = tk.Entry(label_frame_gdhd, textvariable=self._ge.gdhd_motor_displacement_var, font=('calibre', 10, 'normal'))
        ...
        label = tk.Label(label_frame_gdhd, text='Ground Speed(Pot Value)', bg="azure3", width=20)
        label.grid(row=4, column=1)
        self._ge.gdhd_ground_speed_label = tk.Entry(label_frame_gdhd, font=('calibre', 10, 'normal'))
        self._ge.gdhd_ground_speed_label.grid(row=4, column=2)
        self._ge.gdhd_ground_speed_label.insert(0, self._ge.gdhd_ground_speed)

        label = tk.Label(label_frame_gdhd, text='Gear Speed(Pot Value)', bg="azure3", width=20)
        label.grid(row=4, column=4)
        self._ge.gdhd_gear_speed_label = tk.Entry(label_frame_gdhd, font=('calibre', 10, 'normal'))
    ...
    def generate_ui_rssp(self):
        ...
        label_frame_rssp = tk.LabelFrame(
            self._ge.plant_model_ucm3_frame, text='RSSP',)
        label_frame_rssp.pack(expand='yes', fill='both')

        label = tk.Label(label_frame_rssp, text='Plant enable',
                         bg="azure3", width=20)
        label.grid(row=1, column=1)
        ...
        label = tk.Label(label_frame_rssp,
                         text='rssp right sol', bg="azure3", width=20)
        rssp_right_sol_entry = tk.Entry(
            label_frame_rssp, textvariable=self._ge.rssp_right_pwm_var, font=('calibre', 10, 'normal'))
        ...
        label = tk.Label(label_frame_rssp, text='rssp left sol',
                         bg="azure3", width=20)
        ...
        label = tk.Label(label_frame_rssp,
                         text='crop_load_right', bg="azure3", width=20)
        label.grid(row=4, column=1)
        w1 = tk.Scale(label_frame_rssp, from_=0, to=100,
                      orient=tk.HORIZONTAL, variable=self._ge.crop_load_right_rssp_var)
        w1.set(self._ge.crop_load_right_rssp)
        w1.grid(row=4, column=2)

        b1 = tk.Button(label_frame_rssp, text='Update', fg="white",
                       bg="Steel Blue", command=self.ui_call.rssp_callback)
        b1.grid(row=4, column=3)

        label = tk.Label(label_frame_rssp,
                         text='crop_load_left', bg="azure3", width=20)
        label.grid(row=5, column=1)
        w1 = tk.Scale(label_frame_rssp, from_=0, to=100,
                      orient=tk.HORIZONTAL, variable=self._ge.crop_load_left_rssp_var)
        ...
        label = tk.Label(label_frame_rssp,
                         text='spreader right RPM', bg="azure3", width=20)
        label.grid(row=2, column=4)
        ...
        label = tk.Label(label_frame_rssp,
                         text='spreader left RPM', bg="azure3", width=20)
        label.grid(row=3, column=4)
        ...
        label = tk.Label(label_frame_rssp,
                         text='spreader right curr', bg="azure3", width=20)
        label.grid(row=4, column=4)
        ...
        label = tk.Label(label_frame_rssp,
                         text='spreader left curr', bg="azure3", width=20)
        label.grid(row=5, column=4)
    ...
    def generate_setting_ui(self):
        ...
        # Settings Container
        label_frame_setting = tk.LabelFrame(
            self._ge.setting_frame, text='Setting')
        label_frame_setting.pack(expand='yes', fill='both')

        # Key Status
        label = tk.Label(label_frame_setting,
                         text='Key Status', bg="azure3", width=20)
        label.grid(row=1, column=1)
        self._ge.Key_Button = tk.Button(label_frame_setting, height=1, width=4, bd=6, fg="black", font=(
            'Geneva', 6), bg="Red", command=self.ui_call.key_callback)
        self._ge.Key_Button.grid(row=1, column=2)

        #Battery Key
        label = tk.Label(label_frame_setting, text='Battery on Cmd', bg="azure3", width=20)
        label.grid(row=2, column=1)
        self._ge.Battery_Key_Button = tk.Button(label_frame_setting, height = 1, width = 4, bd=6,fg="Black",bg="Red",command=self.ui_call.battery_key_callback)
        self._ge.Battery_Key_Button.grid(row=2,column=2)

        # Debug Mode
        label_debug = tk.Label(label_frame_setting,
                               text='Debug Mode', bg="azure3", width=20)
        label_debug.grid(row=3, column=1)
        self._ge.debug_mode_button = tk.Button(label_frame_setting, height=1, width=4, bd=6, fg="black", font=(
            'Geneva', 6), bg="Red", command=self.ui_call.debug_callback)
        self._ge.debug_mode_button.grid(row=3, column=2)

        if self._ge.fei_compatible == 1:
            # CPU Usage
            label_cpu = tk.Label(label_frame_setting,
                                 text='CPU Usage', bg='azure3', width=20)
            ...
            label_sim = tk.Label(label_frame_setting,
                                 text='Simulator Mode', bg="azure3", width=20)
            label_sim.grid(row=5, column=1)
            self._ge.sim_button = tk.Button(label_frame_setting, height=1, width=4, bd=6, fg="black", font=(
                'Geneva', 6), command=self.ui_call.sim_callback)
            ...
            self._ge.reset_can_button = tk.Button(label_frame_setting, height=1, width=4, bd=6, fg="black", font=(
                'Geneva', 6), bg="skyblue", command=self.ui_call.reset_CAN)
    ...
    def generate_cc_console_ui(self):
        label_frame_cc_console = tk.LabelFrame(self._ge.setting_frame,text='CSS Console')
